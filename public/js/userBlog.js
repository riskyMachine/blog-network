...
function createCard(data){
    ...
    a.setAttribute('href',`/${data.id}/editBlog`)
...
function noBlogDiv(){
    ...
    div.setAttribute('height', '700px')
    var p = document.createElement('p')
    var textNode = document.createTextNode("You have not authored any blog.")
